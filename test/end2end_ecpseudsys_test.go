...
func TestEndToEnd_PseudonymsysEC(t *testing.T) {
	...
	caClient1, _ := ecpseudsys.NewCAClient(testConn, curveType)
	...
	c2, _ := ecpseudsys.NewClient(testConn, curveType)
