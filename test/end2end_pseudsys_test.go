...
func TestEndToEnd_Pseudonymsys(t *testing.T) {
	...
	caClient1, err := pseudsys.NewCAClient(testConn, group)
	...
	c2, err := pseudsys.NewClient(testConn, group)
